        ...
        return (
            <label className={cn(className, s.input)}>
                ...
                <div
                    className={cn(
                        s.inputContainer,
                        error?.itself && s.inputContainer_error
                    )}
                >
                    <input
                        ref={ref}
                    ...
                    />
                    {after && (
                        <span className={s.inputContainer__after}>{after}</span>
                    )}
                    {onClear && (
                        <span
                            className={cn(
                                s.inputContainer__after,
                                s.input__itemClearButton
                            )}
                        >
                ...
                {error?.itself && (
                    <p className={s.input__errorMessage}>{error.message}</p>
                )}
            </label>
        );
    }
